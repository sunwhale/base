...
class F2Form(FlaskForm):
    ...
    cover_r_out_front = FloatField('头部盖板外半径 (mm)', default=560.0)
    cover_thickness_front = FloatField('头部盖板厚度 (mm)', default=68.0)
    cover_r_out_behind = FloatField('尾部盖板外半径 (mm)', default=940.0)
    cover_thickness_behind = FloatField('尾部盖板厚度 (mm)', default=43.0)

    flange_r_in_front = FloatField('头部法兰内半径 (mm)', default=460.0)
    flange_r_out_front = FloatField('头部法兰外半径 (mm)', default=843.5)
    flange_thickness_front = FloatField('头部法兰厚度 (mm)', default=145.0)
    flange_slope_deg_front = FloatField('头部法兰倾斜角度 (度)', default=-84.88)
    flange_fillet_radius_front = FloatField('头部法兰圆角半径 (mm)', default=10.0)

    flange_r_in_behind = FloatField('尾部法兰内半径 (mm)', default=815.0)
    flange_r_out_behind = FloatField('尾部法兰外半径 (mm)', default=1258.72)
    flange_thickness_behind = FloatField('尾部法兰厚度 (mm)', default=179.0)
    flange_slope_deg_behind = FloatField('尾部法兰倾斜角度 (度)', default=92.78)
    flange_fillet_radius_behind = FloatField('尾部法兰圆角半径 (mm)', default=10.0)

    skirt_r_out_front = FloatField('前裙外半径 (mm)', default=1835.5)
    skirt_r_in_1_front = FloatField('前裙内半径1 (mm)', default=1702.5)
    skirt_r_in_2_front = FloatField('前裙内半径2 (mm)', default=1797.585372)
    skirt_l_1_front = FloatField('前裙长度1 (mm)', default=23.0)
    skirt_l_2_front = FloatField('前裙长度2 (mm)', default=1650.0)
    skirt_offset_front = FloatField('前裙偏移量 (mm)', default=-450.0)

    skirt_r_out_behind = FloatField('后裙外半径 (mm)', default=1835.5)
    skirt_r_in_1_behind = FloatField('后裙内半径1 (mm)', default=1702.5)
    skirt_r_in_2_behind = FloatField('后裙内半径2 (mm)', default=1797.585372)
    skirt_l_1_behind = FloatField('后裙长度1 (mm)', default=23.0)
    skirt_l_2_behind = FloatField('后裙长度2 (mm)', default=1650.0)
    skirt_offset_behind = FloatField('后裙偏移量 (mm)', default=450.0)
