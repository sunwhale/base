...
class F2Form(FlaskForm):
    ...
    d = FloatField('d，mm', default=1.0)
    x0 = FloatField('x0，mm', default=1.0)
    block_length = FloatField('block_length，mm', default=1.0)
    block_insulation_thickness_z = FloatField('block_insulation_thickness_z，mm', default=1.0)
    block_insulation_thickness_t = FloatField('block_insulation_thickness_t，mm', default=1.0)
    block_insulation_thickness_r = FloatField('block_insulation_thickness_r，mm', default=1.0)
    block_gap_z = FloatField('block_gap_z，mm', default=1.0)
    block_gap_t = FloatField('block_gap_t，mm', default=1.0)
    a = FloatField('a，mm', default=1.0)
    b = FloatField('b，mm', default=1.0)
    fillet_radius = FloatField('fillet_radius，mm', default=1.0)
    angle_demolding_1 = FloatField('angle_demolding_1，mm', default=1.0)
    element_size = FloatField('element_size，mm', default=1.0)
    insert_czm = FloatField('insert_czm，mm', default=1.0)
    size = FloatField('size，mm', default=1.0)
    front_ref_length = FloatField('front_ref_length，mm', default=1.0)
    behind_ref_length = FloatField('behind_ref_length，mm', default=1.0)
    r_cut_front = FloatField('r_cut_front，mm', default=1.0)
    length_front = FloatField('length_front，mm', default=1.0)
    p0_front = FloatField('p0_front，mm', default=1.0)
    theta0_deg_front = FloatField('theta0_deg_front，mm', default=1.0)
    p3_front = FloatField('p3_front，mm', default=1.0)
    theta3_deg_front = FloatField('theta3_deg_front，mm', default=1.0)
    r1_front = FloatField('r1_front，mm', default=1.0)
    r2_front = FloatField('r2_front，mm', default=1.0)
    r3_front = FloatField('r3_front，mm', default=1.0)
    theta_in_deg_front = FloatField('theta_in_deg_front，mm', default=1.0)
    r_cut_behind = FloatField('r_cut_behind，mm', default=1.0)
    length_behind = FloatField('length_behind，mm', default=1.0)
    p0_behind = FloatField('p0_behind，mm', default=1.0)
    theta0_deg_behind = FloatField('theta0_deg_behind，mm', default=1.0)
    p3_behind = FloatField('p3_behind，mm', default=1.0)
    theta3_deg_behind = FloatField('theta3_deg_behind，mm', default=1.0)
    r1_behind = FloatField('r1_behind，mm', default=1.0)
    r2_behind = FloatField('r2_behind，mm', default=1.0)
    r3_behind = FloatField('r3_behind，mm', default=1.0)
    theta_in_deg_behind = FloatField('theta_in_deg_behind，mm', default=1.0)
