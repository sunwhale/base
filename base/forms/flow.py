...
class F2Form(FlaskForm):
    ...
    block_gap_z = FloatField('block_gap_z，mm', default=9.0)
    block_gap_t = FloatField('block_gap_t，mm', default=9.0)
    ...
    front_partition_offset = FloatField('头部剖分偏移量，mm', default=300.0)
