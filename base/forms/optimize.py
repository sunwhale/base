...
class F1From(FlaskForm):
    tool_option = RadioField('刀具选项', choices=[('analytical', '理想刀具参数建模'), ('file', '从CAD文件导入')], default='analytical',
    ...
    tool_path_type = RadioField('刀具路径选项', choices=[('square_wave', '方波铣削'), ('drill', '钻孔'), ('tool_path_file', '刀具路径文件')],
                                default='square_wave', validators=[DataRequired()])
