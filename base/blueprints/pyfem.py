...
def view_project(project_id):
    ...
    if os.path.exists(project_path):
        ...
        return render_template('pyfem/view_project.html', project_id=project_id, status=status,
...
def view_job(project_id, job_id):
    ...
    if os.path.exists(job_path):
        ...
        return render_template('pyfem/view_job.html', project_id=project_id, job_id=job_id, status=status, form=form)
    else:
        abort(404)
