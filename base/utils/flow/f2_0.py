...
if __name__ == "__main__":
    ...
    if not ABAQUS_ENV:
        ...
        plot_three_arcs(result, p0_front, p3_front, is_show=False, save_path='../../../recycle/flow/three_arcs_front.png')

        result = solve_three_arcs(p0_behind, theta0_deg_behind, p3_behind, theta3_deg_behind, r1_behind, r2_behind, r3_behind)
        plot_three_arcs(result, p0_behind, p3_behind, is_show=False, save_path='../../../recycle/flow/three_arcs_behind.png')

        plot_blocks_map(block, is_show=False, save_path='../../../recycle/flow/blocks_map.png')
    if ABAQUS_ENV:
        # 初始化part对象
        p_insulation = None
        p_cover_front = None
